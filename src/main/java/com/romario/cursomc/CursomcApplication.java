...
import com.romario.cursomc.domain.Pagamento;
import com.romario.cursomc.domain.PagamentoComBoleto;
import com.romario.cursomc.domain.PagamentoComCartao;
import com.romario.cursomc.domain.Pedido;
...
import com.romario.cursomc.repositories.PagamentoRepository;
import com.romario.cursomc.repositories.PedidoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("85997296407", "85922224444"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Darmim", "38220834", cli1, c1);
